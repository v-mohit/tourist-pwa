...
export default function AuthModal() {
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          'fixed inset-0 bg-[rgba(24,18,14,0.72)] backdrop-blur-[6px] z-[1300] transition-opacity duration-300',
      ...
      <div
        className={clsx(
          'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1400] w-full max-w-sm px-4 transition-all duration-300',
