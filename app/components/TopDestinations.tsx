...
const TopDestinations = ({ destinations }: TopDestinationsProps) => {
  const places = destinations?.Category?.[0]?.places?.data || []
  ...
  return (
    <section id="destinations" className="px-6 md:px-8 py-16 md:py-24 max-w-6xl mx-auto">
      <div className="mb-12">
        ...
        <p className="text-base md:text-lg text-[#7A6A58] max-w-2xl leading-relaxed">
          Discover the most popular and breathtaking destinations across Rajasthan
        </p>
      </div>
